...
class MainProgram:
    ...
    def __init__(self, *, target, num_elements, profile, c1, c2, c3, c4, lambdaEff, raio, 
        ...
        while count3 < self.num_elements:
            ...
            fatorEpsilon = 1 / (1 - (quantidade * (self.r**2) * (1 - intensidadeManchaRazao[count3])))
            ...
            self.intervaloTempo = eclipse_.intervaloTempo  # opcional: armazenar para uso posterior

            eclipse_.setTempoHoras(self.intervaloTempo)
